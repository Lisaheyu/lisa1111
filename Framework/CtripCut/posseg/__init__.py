...
class CnlpTag:
    def __init__(self, cnlp_cut, dict_file):
        self.prob_start = self.load_model("prob_start.py")
        self.prob_trans = self.load_model("prob_trans.py")
        self.prob_emit = self.load_model("prob_emit.py")
        self.char_state_tab = self.load_model("char_state_tab.py")
        self.word_tag_tab = self.load_model("../dict.txt")
